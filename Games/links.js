...
function showTab(tabId) {
    ...
    const loginSection = document.getElementById("login"); // This replaces 'passwordContainer'
    const protectedContent = document.getElementById("protectedContent");

    // Ensure elements exist
    if (!passwordInput || !loginSection || !protectedContent) {
    ...
    if (data.success) {
        loginSection.classList.add("hidden"); // Hides the login section
        protectedContent.classList.remove("hidden"); // Shows protected content
	alert('Sucess! Scroll Down and select.');
    } else {
        triggerPopups(); // Handle incorrect password
    }
}
